...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    formation: 'Biologa nutrizionista e igienista dentale (doppia specializzazione). Approccio olistico focalizzato su prevenzione.',
    treatments: [
  ...
  },
  {
    ...
    formation: 'Laurea Magistrale con lode in Scienze dell’alimentazione. Master in Nutraceutica e Psicologia alimentare.',
    treatments: [
  ...
  },
  {
    ...
    treatments: [
      ...
      'Recupero funzionale e articolare',
      'Benessere posturale preventivo'
    ],
    longBio: 'Lavora nell\'ambito del recupero muscolo-scheletrico. L’osteopatia interviene sul paziente promuovendo le capacità di adattamento e di autoregolazione attraverso una serie di tecniche manipolative.',
  ...
  },
  {
    ...
    formation: 'Laurea in Podologia (110 Lode), Osteopata (C.I.O. Bologna) e Fisioterapista. Master Posturologia Clinica.',
    treatments: [
  ...
  },
  {
    ...
    formation: 'Master Universitari su DCA, Sessuologia, Psicologia dello Sport, Identità Sessuali. Iscr. Ordine 10412.',
    treatments: [
